class ApplicationController < ActionController::Base
  ...
  VALID_SORT_KEYS=["id","identifier","name","client_id","integration_id","starts_at","ends_at","group","integration","client","class","system","on_name","contact","phone","email", "description","debit_system", "group"]
